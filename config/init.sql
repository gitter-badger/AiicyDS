...
INSERT INTO `resource_category` (`name`, `intro`, `ctime`)
VALUES
	('精彩文章', '分享来自互联网关于Go语言的精彩文章', '2013-03-23 20:23:29'),
	('开源项目', '收集优秀的开源项目、第三方库', '2013-03-23 20:23:29'),
	('Go语言资料', 'Go语言书籍、资料，提供下载地址或在线链接', '2013-03-23 20:23:29'),
	('其他资源', '分享跟Go相关或其他有用的资源', '2013-03-25 23:35:07');

...
void Config::set_values(
    ...
    get_instance()->mysql_host = appConfig.get<std::string>(
	"mysql.host"
    );
    get_instance()->mysql_user = appConfig.get<std::string>(
	"mysql.user"
    );
    get_instance()->mysql_password = appConfig.get<std::string>(
	"mysql.password"
    );
    get_instance()->mysql_database = appConfig.get<std::string>(
	"mysql.database"
    );
